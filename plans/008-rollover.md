...
- [ ] Create `tomb-cli/src/rollover.rs`
- [ ] Add `pub mod rollover;` to `lib.rs`
- [ ] Verify: `cargo check -p tomb-cli`

## 2. Entry point — `maybe_rollover(file, today)`
...
## 4. Helper — uncompleted task detection
...
## 6. Section reordering after rollover

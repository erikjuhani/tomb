...
fn generate_tests_from_spec() {
    ...
    for file_path in &spec_files {
        ...
        let mut spec_rs = File::create(&rs_test_file).expect(&format!("Could not create {:?}", rs_test_file));
        ...
        spec_rs
            ...
            .unwrap();
        spec_rs.write_all(b"// Please, do not modify it manually\n").unwrap();
...
"###,
    ...
    let mut mod_rs = File::create(&suite_mod_file).expect(&format!("Could not create {:?}", &suite_mod_file));

    mod_rs
        .write_all(b"// This file is auto-generated by the build script\n")
        .unwrap();
    mod_rs.write_all(b"// Please, do not modify it manually\n").unwrap();
...
impl<'a> Iterator for Spec<'a> {
    ...
    fn next(&mut self) -> Option<TestCase> {
        ...
        let i_end = self.spec[i_start..].find("\n.\n").map(|pos| (pos + 1) + i_start)?;
